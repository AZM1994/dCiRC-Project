%% For genotype DBP338, Generate phase response curve (PRC) with the best fitting dCiRC paramters
...
text(29,2.3,'advance','Color','r','FontSize',42,'Rotation',0);
text(23+1.5,-0.35,'delay','Color','b','FontSize',42,'Rotation',0);
